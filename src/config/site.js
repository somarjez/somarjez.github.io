export const site = {
  ...
  tagline: 'A fourth-year Computer Science student turning data and ideas into clean, working software.',
  hero:
  ...
  skills: [
    ...
    },
    {
      ...
      tags: ['Leadership', 'Communication', 'Sports Coaching', 'Sports'],
    },
    {
      icon: 'fa-tools',
      title: 'Tools',
      tags: ['Git / GitHub', 'VS Code', 'Figma', 'Microsoft Power BI', 'Tableau', 'Microsoft Excel', 'Jupyter', 'Diff Tools'],
    },
  ],
  ...
  // `expires` is optional and holds a formatted expiration date, shown next to `issued` when present.
  experience: [
    {
      ...
      skills: ['Management Information Systems (MIS)', 'Office Administration', 'System Administration', 'Encoding', 'Support Services', 'Student Welfare', 'Microsoft Excel', 'Leadership'],
    },
    {
      ...
      skills: ['Data Cleaning', 'Scikit-Learn', 'Research Skills', 'Pearson Correlation', 'Error Analysis', 'Statistical Data Analysis', 'Data Entry', 'Educational Research', 'Scholarly Research'],
    },
    {
      ...
      skills: ['Academic Writing', 'Creative Writing', 'Technical Writing', 'Presentations', 'Understand & Convey Complex Information'],
    },
    {
      ...
      skills: ['Web Development', 'User Interface Design', 'User Experience (UX)', 'Quality Assurance', 'Software Development Life Cycle (SDLC)'],
    },
    {
      role: 'Student Staff',
